<template>
    <DialogSetting
            v-if="visible"
            :title="$t('navigation.approve_borrow')"
            :onAccept="handleAccept"
            :cancelDialog="cancelDialog"
    >
        <i18n
                path="dialogs.sure_to_approve_borrow"
                tag="div"
        >
    ...
    export default {
        ...
        methods: {
            ...
            handleAccept: function(){
                axios.post(process.env.VUE_APP_SERVER_URL + 'api/app/borrows/' + this.borrow.id + '/approve/')
